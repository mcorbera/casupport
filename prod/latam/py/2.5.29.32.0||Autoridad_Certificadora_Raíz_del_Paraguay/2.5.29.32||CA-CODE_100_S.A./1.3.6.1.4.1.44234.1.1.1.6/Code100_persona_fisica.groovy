...
public class Firmaprofesional_Vinculado_SW extends AccionScript {
	...
	public Object execute(Map m) {
		...
		CASupport support = new CASupport(	"Code100",
											"1.3.6.1.4.1.44234.1.1.1.6", //OID de la política de certificado
											"Code100", //nombre de la CA
											"Code100", //nombre del certificado 
											...
											"Certificado Persona Física", //descripción del certificado
	...
	public String getNombre(){
		return "Code100"; //sustituir con el nombre deseado
	}
