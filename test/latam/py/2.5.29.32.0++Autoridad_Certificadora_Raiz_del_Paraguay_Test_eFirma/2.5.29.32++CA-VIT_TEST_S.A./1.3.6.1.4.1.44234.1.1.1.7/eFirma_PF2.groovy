...
public class eFirma_PF extends AccionScript {
	...
	public Object execute(Map m) {
		...
		CASupport support = new CASupport("eFirma","1.3.6.1.4.1.44234.1.1.1.7","eFirma","eFirma",
			...
			PredefinedCAs.loadCer("https://www.efirma.com.py/repositorio/ac_raiz_py_sha256.crt"),
			PredefinedCAs.loadCer("https://www.efirma.com.py/repositorio/eFirma.crt")
		);
		return support;
	}	
	/**
